...
const RunLevelAndTarget = () => {
    return (
        <div className='mx-4 my-4 lg:max-w-4xl lg:mx-auto'>
            ...
            <Supersubheading text={`Types of Run Levels`} />
            ...
            <Text text={`Note: Live servers typically run on run level 3 or 5, depending on whether they need a graphical interface.`} />

            <Supersubheading text={`Checking Current Run Level`} />
            <TerminalOutput content={`[root@localhost ~]# runlevel
N 3
[root@localhost ~]#`} />
...
`} />
            ...
            <Text text={`Note: In RHEL-7 and later, modifying /etc/inittab has no effect, as systemd manages the boot process.`} />

            <Subheading text={`Targets`} />
            ...
            <Supersubheading text={`Types of Targets`} />
            ...
            <Text text={`Note: In systemd, there are no equivalents for init 2 and init 4, as these run levels have been removed.`} />

            <Supersubheading text={`Entering Single User Mode (Troubleshooting)`} />
            ...
            {/* <Subheading text={`Comparison Between Run Level and Target`} /> */}
